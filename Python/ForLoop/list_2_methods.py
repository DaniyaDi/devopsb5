...
# what if I want to add a new element to this likst?
...
# will be the place(index) of second argument in list when it is added.
...
#Extend method 
# It will add another list to a list that is applied.
