...
# Ask user enter a string with two words.
...
# how many space do you expect in a string with two words?
# 1 
# how can I find the number of spaces in given string?
# using count method with space argument.
# to remove leading and trailing space I can use strip() method.
...
if count_of_spaces == 1:
    ...
    first_word = words[:index_of_space]
