...
#2. spaces that takes code to the next line (this will effect the output of the code)
#3. spaces that is in the beginning of the line (indents)
# indentation are expected when a code belongs to certain group of implementations.
